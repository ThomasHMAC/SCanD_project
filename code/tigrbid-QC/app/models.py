...
class QCRecord(BaseModel):
    ...
    complete_timestamp: Annotated[Optional[str], Field(description="Completion date")] = None
    rater: Annotated[Optional[str], Field(description="Name of the rater")] = None
    metrics: Annotated[List[MetricQC], Field(description="List of metrics/criteria for this subject")]
